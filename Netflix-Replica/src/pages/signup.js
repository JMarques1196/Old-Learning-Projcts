...
export default function Signup(){
    ...
    const handleSignup = (event) =>{
        ...
        .then((userCredential) =>{
            ...
            updateProfile(user, { // updateProflie Method allows us to update basic profile info (name and user profile photo)
                // we need to run it here since we are creating the Profile.
